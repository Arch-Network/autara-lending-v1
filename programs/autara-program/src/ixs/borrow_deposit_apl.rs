...
pub struct BorrowDepositAplAccounts<'a, 'b> {
...
impl<'a, 'b> BorrowDepositAplAccounts<'a, 'b> {
    #[inline(never)]
...
mod tests {
    ...
    pub fn validate_correct_accounts() {
        ...
        BorrowDepositAplAccounts::from_accounts(&mut accounts_iter.into_iter()).unwrap();
    }
    ...
    pub fn validate_fails_if_market_mismatch() {
        ...
        let accounts_iter = accounts.iter();
        let result = BorrowDepositAplAccounts::from_accounts(&mut accounts_iter.into_iter());
