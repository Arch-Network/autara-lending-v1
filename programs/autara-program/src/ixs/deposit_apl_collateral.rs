...
pub struct DepositAplCollateralAccounts<'a, 'b> {
...
mod tests {
    ...
    pub fn validate_correct_accounts() {
        ...
        DepositAplCollateralAccounts::from_accounts(&mut accounts_iter.into_iter()).unwrap();
    }
    ...
    pub fn validate_fails_if_market_mismatch() {
        ...
        let accounts_iter = accounts.iter();
        let result = DepositAplCollateralAccounts::from_accounts(&mut accounts_iter.into_iter());
