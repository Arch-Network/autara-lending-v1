...
pub struct WithdrawRepayAplAccounts<'a, 'b> {
    ...
    pub authority_supply_ata: PackedOwnedAccount<'a, 'b, BoxedTokenAccount>,
    pub market_supply_vault: PackedOwnedAccount<'a, 'b, BoxedTokenAccount>,
    pub authority_collateral_ata: PackedOwnedAccount<'a, 'b, BoxedTokenAccount>,
    pub market_collateral_vault: PackedOwnedAccount<'a, 'b, BoxedTokenAccount>,
    pub supply_mint_program: Program<'a, 'b, AplTokenProgram>,
...
impl<'a, 'b> WithdrawRepayAplAccounts<'a, 'b> {
        ...
        'a: 'b,
    {
        let this = Self {
            ...
            supply_mint_program: next_account_info(accounts)?.try_into()?,
...
mod tests {
    ...
    pub fn validate_correct_accounts() {
        ...
        WithdrawRepayAplAccounts::from_accounts(&mut accounts_iter.into_iter()).unwrap();
    }
    ...
    pub fn validate_fails_if_market_mismatch() {
        ...
        let accounts_iter = accounts.iter();
        let result = WithdrawRepayAplAccounts::from_accounts(&mut accounts_iter.into_iter());
    ...
    #[test]
    pub fn validate_fails_if_autority_is_not_signer() {
    ...
    #[test]
    pub fn validate_fails_if_market_is_not_owned_by_create() {
        let mut account_set_a = AutaraAccounts::new();
    ...
    #[test]
    pub fn validate_fails_if_position_is_not_owned_by_create() {
        let mut account_set_a = AutaraAccounts::new();
    ...
    #[test]
    pub fn validate_fails_if_supply_vault_mismatch() {
        let account_set_a = AutaraAccounts::new();
        let account_set_b = AutaraAccounts::new();
        let accounts = [
            account_set_a.market.clone(),
    ...
    #[test]
    pub fn validate_fails_if_collateral_vault_mismatch() {
        let account_set_a = AutaraAccounts::new();
        let account_set_b = AutaraAccounts::new();
        let accounts = [
            account_set_a.market.clone(),
